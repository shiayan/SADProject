    ...
    e = function () {
        ...
        e.prototype.add_option = function (e, t, n) {
            if (e.nodeName.toUpperCase() === "OPTION") {
                if (e.text !== "") {
                    if (t != null)this.parsed[t].children += 1;
    ...
    e = function () {
        ...
        e.prototype.result_add_option = function (e) {
            ...
            if (!e.disabled) {
                ...
                if (e.selected)t.push("result-selected");
                if (e.group_array_index != null)t.push("group-option");
                if (e.classes !== "")t.push(e.classes);
...
(function () {
    ...
    t = function (t) {
        ...
        i.prototype.set_up_html = function () {
            ...
            t = e("<div />", {id: this.container_id, "class": "chzn-container" + (this.is_rtl ? " chzn-rtl" : ""), style: "width: " + this.f_width + "px;"});
            if (this.is_multiple) {
                t.html('<ul class="chzn-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chzn-drop" style="right:-9000px;"><ul class="chzn-results"></ul></div>')
            } else {
                t.html('<a href="javascript:void(0)" class="chzn-single chzn-default" tabindex="-1"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="right:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>')
            }
            ...
            i = this.f_width - n(this.dropdown);
            this.dropdown.css({width: i + "px", top: r + "px"});
            ...
            if (this.is_multiple) {
                ...
                s = i - n(this.search_container) - n(this.search_field);
                this.search_field.css({width: s + "px"})
            }
            this.results_build();
            this.set_tab_index();
        ...
        i.prototype.results_show = function () {
            ...
            this.dropdown.css({top: e + "px", right: 0});
        ...
        i.prototype.results_hide = function () {
            ...
            this.dropdown.css({right: "-9000px"});
        ...
        i.prototype.choice_destroy = function (e) {
            if (this.result_deselect(e.attr("rel"))) {
                ...
                return e.parents("li").first().remove()
            }
        };
        ...
        i.prototype.result_select = function (e) {
            ...
            if (this.result_highlight) {
                ...
                if (!(e.metaKey && this.is_multiple))this.results_hide();
                this.search_field.val("");
        ...
        i.prototype.keydown_arrow = function () {
            ...
            if (!this.result_highlight) {
                ...
                if (t)this.result_do_highlight(e(t))
            } else if (this.results_showing) {
                n = this.result_highlight.nextAll("li.active-result").first();
                if (n)this.result_do_highlight(n)
            }
        ...
        i.prototype.keydown_checker = function (e) {
            ...
            switch (t) {
                case 8:
                    ...
                    break;
                case 9:
                    if (this.results_showing && !this.is_multiple)this.result_select(e);
                    this.mouse_on_container = false;
                    break;
                case 13:
                    e.preventDefault();
        ...
        i.prototype.search_field_scale = function () {
            ...
            if (this.is_multiple) {
                r = 0;
                u = 0;
                s = "position:absolute; right: -1000px; top: -1000px; display:none;";
                ...
                u = n.width() + 25;
                n.remove();
                if (u > this.f_width - 10)u = this.f_width - 10;
